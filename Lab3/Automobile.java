/**
   ...
   constructor nethod via the parameter, and the initial fuel level is 0. Supply a method called drive
   ...
   Look at the tester code for help 
...
{  
    ...
    /**
       Constructs a automobile with a zero fuel and given efficiency
       @param kmPerLiter
    */
    ...
    */
    ...
    {  
    	...
    	//2. update the fuel instance variable
    	fuel -= gasUsed;
    	//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
    }
